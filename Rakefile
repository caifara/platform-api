...
task :build do
  ...
  sh 'bundle exec heroics-generate -H "Accept: application/vnd.heroku+json; version=edge" -c "#{Dir.home}/.heroics/platform-api" PlatformAPI schema.json https://api.heroku.com > lib/platform-api/client.rb'
end
